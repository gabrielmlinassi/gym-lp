...
const s = {
  ...
  content: /*tw:*/ `dialog--scrollbar fixed z-30 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] max-h-[90vh] overflow-auto bg-gray-600 pt-12 px-8 pb-14 rounded-3xl rdx-state-open:animate-fade-in rdx-state-closed:animate-fade-out`,
